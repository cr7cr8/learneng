...
function RowItem0({ drag, getIndex, isActive, item, inputRefEn, inputRefCn, data, setData, sourceWord }) {
...
function RowItem({ drag, getIndex, isActive, item, inputRefEn, inputRefCn, data, setData, sourceWord }) {
    ...
    const { englishitem, chineseItem, enFirstTimeAmount, enSecondTimeAmount, cnFirstTimeAmount, cnSecondTimeAmount } = item
    const selfPanel = useRef()
