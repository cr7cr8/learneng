                ...
                Gesture.Tap().numberOfTaps(2)
                    ...
                    .onEnd((e) => {
                        ...
                        if (e.absoluteX <= 100) {
                            ...
                            // console.log( e.absoluteY - (screenHeight- frameTransY.value ))
...
function SentenceBlock({ index, arrIndex, children, visibleCard, shouldCheckDownload = true, wordRowHeight, meaningRowHeight, ...props }) {
    ...
    const { sourceWordArr, frameTransY, isCardMoving, downloadWord, refreshState, isScrollingY, isScrollingX, speak, isListPlaying, checkPlaying, audioPlayer, stopSpeak }
        = useContext(Context)
    const sourceWord = sourceWordArr[index]
